...
const Banner = () => {
  ...
  <div id="slide1" className="carousel-item relative w-full max-w-[1600px] h-[500px]">
    <img src="https://i.ibb.co/89gW3DD/11062b-f6aea162810b41579fefd78d9a09bfe3-mv2.webp"className="w-full"/>
  ...
  <div id="slide2" className="carousel-item relative w-full  max-w-[1600px] h-[500px]">
    <img src="https://i.ibb.co/ZhLQZVf/146418171-diy-and-home-improvement-banner-with-work-and-construction-tools-on-a-wooden-workbench-top.webp" className="w-full"/>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
